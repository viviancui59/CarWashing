...
//	private Toolbar mToolbar;
    ...
    //   resideMenu.setMenuListener(menuListener);
        ...
        itemHome     = new ResideMenuItem(this, R.drawable.icon_home,     "车辆信息");
        itemProfile  = new ResideMenuItem(this, R.drawable.icon_profile,  "消息通知");
        itemCalendar = new ResideMenuItem(this, R.drawable.icon_calendar, "功能介绍");
        itemSettings = new ResideMenuItem(this, R.drawable.icon_settings, "关于我们");
        itemyijian = new ResideMenuItem(this, R.drawable.icon_settings, "意见反馈");
	...
	public void onClick(View v) {
        ...
        if (v == itemHome){ //车辆信息
          ...
          //  changeFragment(new ProfileFragment());
        	Intent intent = new Intent(MainActivity.this,MessagePageActivity.class);//////
