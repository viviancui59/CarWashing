...
import com.example.fragmentdemo.OrderWashActivity.OrderRunner;
import com.example.fragmentdemo.OrderWashActivity.SuccessImpl;
...
public class OrderMaintenanceActivity extends Activity {


	private TextView txtMainDate;
	private Button btnSelectMainDate;
	private Button btnSelectMainTime;
	private Button btnOrderMain;
	private TextView txtOrderMainDate;
	private TextView txtOrderMainTime;
	private Spinner spnMainCar;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_order_maintenance);
		
		SimpleDateFormat df=new SimpleDateFormat("yyyy-MM-dd");
		todaydate=df.format(new Date());
		
		txtMainDate=(TextView)findViewById(R.id.txtMainDate);
		txtOrderMainDate=(TextView)findViewById(R.id.txtOrderMainDate);
		txtOrderMainTime=(TextView)findViewById(R.id.txtOrderMainTime);
		btnSelectMainDate=(Button)findViewById(R.id.btnSelectMainDate);
		btnSelectMainTime=(Button)findViewById(R.id.btnSelectMainTime);
		btnOrderMain=(Button)findViewById(R.id.btnOrderMain);
		spnMainCar=(Spinner)findViewById(R.id.spnMainCar);
		
		txtMainDate.setText(todaydate);
		...
		*/
        ...
        //将适配器添加到下拉列表上    
		spnMainCar.setAdapter(carAdapter);    
        //为下拉列表设置各种事件的响应，这个事响应菜单被选中    
		spnMainCar.setOnItemSelectedListener(new Spinner.OnItemSelectedListener(){    
	...
	private DatePickerDialog.OnDateSetListener Datelistener=new DatePickerDialog.OnDateSetListener()
    {
        ...
        private void updateDate()
        {
           ...
           txtOrderMainDate.setText(orderdate);
        }
    };
		  ...
		  private void updateTime()
	        {
			  ...
			  if(hour<10)
			  {
	           ...
	           txtOrderMainTime.setText(ordertime);
	        }
    };
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.order_maintenance, menu);
		return true;
	}

	public void back(View v){
		Intent intent = new Intent(OrderMaintenanceActivity.this,MainActivity.class);		 
	...
	public void selectDate(View v){
		...
		datedialog=new DatePickerDialog(OrderMaintenanceActivity.this,Datelistener,year,month,day);
	...
	public void selectTime(View v){
		timedialog=new TimePickerDialog(OrderMaintenanceActivity.this,Timelistener,hour,minute,true);
		timedialog.show();

	}
	public void orderMain(View v)throws ParseException{
	...
	public class OrderRunner implements Runnable {
		...
		public void run() {
			...
			params.add(new BasicNameValuePair("price", "180"));
