...
import com.example.fragmentdemo.CarInformationActivity.MyCarRunner;
...
public class ShowCarBrandActivity extends Activity {
	...
	private String url="http://10.130.58.126:8080/CarWashing/FindCarBrandServlet";
	/**
	 * ����ת����ƴ������
	 */
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		adapter = new SortAdapter(getApplicationContext(), SourceDateList,imageCache,sdcardCacheDir);
